...
while(my $subdir = readdir(DIR)) {
    ...
    system("salmon quant -i $indexSalmonQuasi -l U -p $cpu -r $read1 -o $salmonQuasidir");

    mkdir $salmonFMDdir;
    system("salmon quant -i $indexSalmonFMD -l U -p $cpu -r $read1 -o $salmonFMDdir");
